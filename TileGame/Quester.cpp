...
void Quester::render(Handler* handler) {
	...
	if (enabled) {
		...
		interact.setPosition(x - handler->currentCameraXOffset + w / 2.f - interactTexture->getSize().x * 3.f / 2.f, y - handler->currentCameraYOffset + yExtra - interactTexture->getSize().y * 3.f + 9);
		...
		interact.setPosition(x - handler->currentCameraXOffset + w / 2.f - questTexture->getSize().x * 3.f / 2.f, y - handler->currentCameraYOffset + yExtra - questTexture->getSize().y * 3.f + 9);
